...
func newTestHTTPServerWithState(t *testing.T) (*httptest.Server, *stateStore) {
	...
	mux.HandleFunc("/api/v1/views/front-page", s.frontPageViewHandler)
	...
	mux.HandleFunc("/api/v1/views/projects/", s.projectDetailsViewHandler)
	...
	mux.HandleFunc("/api/v1/job-queue/layout", s.jobQueueLayoutHandler)
	mux.HandleFunc("/api/v1/job-queue/cards", s.jobQueueCardsHandler)
	mux.HandleFunc("/api/v1/job-history/layout", s.jobHistoryLayoutHandler)
	mux.HandleFunc("/api/v1/job-history/cards", s.jobHistoryCardsHandler)
